...
func (c *Network) Build(vgin *vugu.BuildIn) (vgout *vugu.BuildOut) {
	...
	vgout.Out = append(vgout.Out, vgn)	// root for output
	{
		...
		{
			vgcompKey := vugu.MakeCompKey(0x5E6F806D97E00345, vgiterkey)
		...
		vgparent.AppendChild(vgn)
		{
			vgcompKey := vugu.MakeCompKey(0x5E6F806D05598E0B, vgiterkey)
			// ask BuildEnv for prior instance of this specific component
		...
		for vgiterkeyt, mirNode := range c.MirNodes {
			...
			_ = mirNode
			{
				vgcompKey := vugu.MakeCompKey(0x5E6F806DD75676E0, vgiterkey)
				// ask BuildEnv for prior instance of this specific component
